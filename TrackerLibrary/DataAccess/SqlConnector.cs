    ...
    public class SqlConnector : IDataConnection
    {
        public void CreatePerson(PersonModel model)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(GlobalConfig.CnnString("Tournaments")))
            {
                ...
                //retrieves index fro db and adds to the model
        ...
        //TODO - Make the prize model actually save to the database
        /// <summary>
        ...
        public void CreateTournament(TournamentModel model)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(GlobalConfig.CnnString("Tournaments")))
            {
                SaveTournamnet(connection, model);
        ...
        private void SaveTournamentRounds(IDbConnection connection, TournamentModel model)
        {
            ...
            //Inside round loop, loop thru the matchups
            //save the matchup
            //loop thru the entries and save them
        ...
        private void SaveTournamnet(IDbConnection connection, TournamentModel model)
        {
            var p = new DynamicParameters();
